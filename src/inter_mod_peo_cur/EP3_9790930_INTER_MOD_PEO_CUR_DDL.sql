...
CREATE TABLE IF NOT EXISTS b19_PLANEJA (
	...
	CONSTRAINT sk_planeja01 UNIQUE (al_pe_nusp),
	CONSTRAINT sk_planeja02 UNIQUE (dis_data_inicio, dis_departamento, dis_codigo)
);
...
CREATE TABLE IF NOT EXISTS b20_MINISTRA (
	...
	CONSTRAINT sk_ministra01 UNIQUE (pf_pe_nusp),
	CONSTRAINT sk_ministra02 UNIQUE (dis_data_inicio, dis_departamento, dis_codigo)
);
