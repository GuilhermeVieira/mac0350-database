...
INSERT INTO table (pe_nusp, status, email, sala, site) VALUES (9, ‘at’, ‘cf@ime.usp.br’, ‘ime.usp.br/~cf’, );
...
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘1987’, ‘MAE’, ‘0123’, ‘sgldis=MAE0123’, ‘Introdução a bob’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, ‘2004’);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘1997’,’MAC’,’0350’, ‘sgldis=MAC0350’, ‘Introdução a JEF’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, ‘2001’);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘2005’,’MAC’,’0121’, ‘sgldis=MAC0121’, ‘Introdução a algorimos’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, NULL);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘1997’,’MAC’,’0425’, ‘sgldis=MAC0425’, ‘Robozinho’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, ‘2003’);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘2018’,’MAT’,’0256’, ‘sgldis=MAT0256’ ‘Calc Pi’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, NULL);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘1981’,’MAT’,’0359’, ‘sgldis=MAT0359’, ‘Logick’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, ‘1999’);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘2005’,’MAE’,’0666’, ‘sgldis=MAE0666’, ‘Inferno’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, NULL);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘2011’,’MAE’,’9889’, ‘sgldis=MAE9889’, ‘Amostragem de dados virtualmente obscuros’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, ‘2014’);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘2016’,’MAC’,’0300’, , ‘sgldis=MAC0300’, ‘Metodos Nabos’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, NULL);
INSERT INTO table (data_inicio, departamento, codigo, jupiter_link, nome, descricao, data_fim) VALUES (‘1993’,’MAC’, ‘0460’, ‘sgldis=MAC0460’, ‘Intro a Buzzword’, ‘Lorem ipsum dolor sit amet, consectetur adipiscing elit’, NULL);
...
INSERT INTO b16_REL_CUR_TRI (cur_codigo, tri_tri_id, obrigatoria) SELECT 1, tri_id, FALSE FROM b13_TRILHA WHERE  nome = ‘Obrigatoria’ LIMIT BY 1;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 2, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘IA’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 3, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘Teoria’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 4, tri_id, FALSE FROM b13_TRILHA WHERE  nome = ‘Obrigatoria’ LIMIT BY 1;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 5, tri_id, FALSE FROM b13_TRILHA WHERE  nome = ‘Sisteminhas’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 5, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘Optativa eletiva’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 5, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘Sisteminhas’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 8, tri_id, FALSE FROM b13_TRILHA WHERE  nome = ‘Aquela la’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 10, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘Obrigatoria’;
INSERT INTO b16_REL_CUR_TRI
 (cur_codigo, tri_tri_id, obrigatoria) SELECT 10, tri_id, TRUE FROM b13_TRILHA WHERE  nome = ‘Aquela la’;

b17_TR_MO

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) SELECT tri_id, mod_id, 10, TRUE, 1000 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Direito Contitucional’ AND mo.nome = ‘Obrigatorias’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 6, TRUE, 999 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Obrigatoria’ AND mo.nome = ‘Robos’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 10, FALSE, 998 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Doidera’ AND mo.nome = ‘Robos’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 14, TRUE, 997 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Obrigatoria’ AND mo.nome = ‘Nabo’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 30, FALSE, 996 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Engengerotreco’ AND mo.nome = ‘Robos’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 12, TRUE, 995 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Aquela la’ AND mo.nome = ‘Coxa’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 24, TRUE, 25 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Doidera’ AND mo.nome = ‘Nabo’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 8, FALSE, 20 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Teoria’ AND mo.nome = ‘Obrigatorias’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) VALUES SELECT tri_id, mod_id, 20, FALSE, 10 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Engengerotreco’ AND mo.nome = ‘Coxa’ LIMIT BY 1;

INSERT INTO b17_TR_MO (tri_tri_id, mo_mod_id, min_creds, obrigatorio, min_dis) SELECT tri_id, mod_id, 30, TRUE, 10 FROM b13_TRILHA tr, b12_MODULO mo WHERE tr.nome = ‘Obrigatoria’ AND mo.nome = ‘Nabo’ LIMIT BY 1;

b18_REL_DIS_MOD

173     mo_mod_id           int NOT NULL,
174     dis_data_inicio     char(4) NOT NULL,
175     dis_departamento    char(3) NOT NULL,
176     dis_codigo          char(4) NOT NULL,
177     obrigatorio         BOOLEAN NOT NULL DEFAULT TRUE,

INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1997’, ‘MAC’, ‘0350’, TRUE FROM b12_MODULO WHERE  nome = ‘Sisteminhas’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio)SELECT mod_id, ‘2018’, ‘MAT’, ‘256’, TRUE FROM b12_MODULO WHERE  nome = ‘Sisteminhas’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘2011’, ‘MAE’, ‘9889’, TRUE FROM b12_MODULO WHERE  nome = ‘Pura’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1997’, ‘MAC’, ‘0350’, TRUE FROM b12_MODULO WHERE  nome = ‘Obrigatorias’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1997’, ‘MAC’, ‘0350’, TRUE FROM b12_MODULO WHERE  nome = ‘Coxa’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘2005’, ‘MAE’, ‘0666’, TRUE FROM b12_MODULO WHERE  nome = ‘Sisteminhas’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1981’, ‘MAT’, ‘0359’, TRUE FROM b12_MODULO WHERE  nome = ‘Robos’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1997’, ‘MAC’, ‘0350’, TRUE FROM b12_MODULO WHERE  nome = ‘Nabo’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘2016’, ‘MAC’, ‘0300’, TRUE FROM b12_MODULO WHERE  nome = ‘Sisteminhas’ LIMIT BY 1;
INSERT INTO b18_REL_DIS_MOD (mo_mod_id, dis_data_inicio, dis_departamento, dis_codigo, obrigatorio) SELECT mod_id, ‘1993’, ‘MAC’, ‘0460’, TRUE FROM b12_MODULO WHERE  nome = ‘Data Science’ LIMIT BY 1;
