...
DROP FUNCTION IF EXISTS adiciona_disciplina(CHAR(4), CHAR(3), CHAR(4), VARCHAR(100), VARCHAR(100), VARCHAR(100), CHAR(4));
...
DROP FUNCTION IF EXISTS pega_disciplinas_cursadas(INT, INT, INT);
